  ...
  return (
    <div className="flex h-screen w-full ">
      ...
      <video className="w-full h-full object-cover" src={Background} autoPlay loop muted />
        ...
        <h1 className="text-5xl outline font-extrabold text-transparent bg-clip-text bg-gradient-to-tr from-[#080398e3] via-[#1fe5ff] to-[#00e1ffe0] ml-24 ">ArcStar</h1>
        ...
        <div className="flex w-80 m-16 ml-28 ">
          <img className="rounded-full" src={Image} />
            <div className="flex gap-10 m-20 text-white text-xl font-semibold">
              ...
              <NavLink href="#" target="blank">
                <div className="bg-gradient-to-tr from-[#080398e3] via-[#0069fc] to-[#00e1ffe0] h-40 w-52 justify-center text-center p-4 hover:scale-110 duration-200">
